...
ActiveRecord::Schema.define(version: 20180426131312) do
  ...
  create_table "settings", force: :cascade do |t|
    ...
    t.string   "local_max_char",                   default: "Maximum length 80 characters."
    t.string   "local_max_suggest",                default: "Too many submissions. Please wait."
  end
